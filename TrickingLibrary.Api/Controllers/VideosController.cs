...
namespace TrickingLibrary.Api.Controllers
{
    ...
    public class VideosController : ControllerBase
    {
        ...
        public IActionResult GetVideo(string video)
        {
            ...
            return new FileStreamResult(new FileStream(savePath, FileMode.Open, FileAccess.Read), $"video/{mime}");
        }

        [HttpPost]
        public async Task<IActionResult> UploadResult(IFormFile video)
        {
